...
//        console.log(o.launch_date_unix);
        ...
        console.log(dato);
        launchesDiv.innerHTML +="<div class='collum-tablet-4'><div class='infoContent'>" + o.mission_name + "<br>" + o.rocket.rocket_name + "<br>" + dayUnixDate+"/"+monthUnixDate +"/"+ unixDate.getFullYear() + "<hr></div></div>";
    }
